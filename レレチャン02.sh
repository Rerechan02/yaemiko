...
cd
rm -rf dnstt
dnstt-server -gen-key -privkey-file /kamui/dnstt/server.key -pubkey-file /etc/slowdns/server.pub
...
screen -AmdS dnstt dnstt-server -udp :5300 -privkey-file /etc/slowdns/server.key ns-${nsdomain} 127.0.0.1:85
#!/bin/bash
#
# ==================================================
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
wget -O /usr/sbin/badvpn "https://raw.githubusercontent.com/Rerechan02/nani/main/badvpn" >/dev/null 2>&1
